...
![header](https://capsule-render.vercel.app/api?type=waving&color=0:2F80ED,100:56CCF2&height=180&section=header&text=KDongGyu1&fontSize=42&fontColor=ffffff&animation=fadeIn&fontAlignY=36&desc=Developer%20%7C%20Security%20Learner%20%7C%20Builder&descAlignY=58&descSize=16)

### 안녕하세요, 꾸준히 배우고 만드는 **김동규**입니다.

AI를 활용해 학습과 개발의 효율을 높이고,  
정보보호 관점에서 더 안전한 서비스를 고민하며 성장하고 있습니다.
...
- 현재 정보보안기사 필기, 정보처리기사 실기를 준비하며 학습하고 있습니다.
...
AI 활용 역량과 정보보호 관점을 바탕으로, 안전하고 실용적인 서비스를 만들어가겠습니다.
